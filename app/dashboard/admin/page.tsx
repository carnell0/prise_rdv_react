...
import { Users, UserCheck, Calendar, TrendingUp, Search, Filter, MoreHorizontal } from 'lucide-react'
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium">{totalPatients}</span>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm">Nouveau patient inscrit</span>
                  <span className="text-xs text-muted-foreground ml-auto">Il y a 2h</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full" />
                  <span className="text-sm">RDV confirmé par Dr. Martin</span>
                  <span className="text-xs text-muted-foreground ml-auto">Il y a 4h</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-orange-600 rounded-full" />
                  <span className="text-sm">Nouveau médecin en attente</span>
